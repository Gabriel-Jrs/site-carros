function personagens() {
    const personagensInfo = {
        "Relâmpago McQueen": {
            ...
            desc: "Um dos carros de corrida mais famosos da história da Copa Pistão, Relâmpago McQueen é ambicioso, competitivo e extremamente determinado. No primeiro filme, sua jornada egoísta o leva à pacata Radiator Springs, onde aprende sobre amizade, humildade e o verdadeiro significado da vitória. Ao longo da trilogia, evolui de novato arrogante para mentor generoso."
        },
        "Doc Hudson": {
            img: "img/doc.jpg",
            model: "Modelo inspirador: Hudson Hornet de 1951",
            desc: "Conhecido como o Fabuloso Hudson Hornet, Doc foi campeão da Copa Pistão antes de um acidente encerrar sua carreira. Tornou-se médico e juiz de Radiator Springs, onde vive em anonimato até ser redescoberto por McQueen. Torna-se mentor e figura paterna para o jovem corredor."
        },
        "Mate": {
            img: "img/mate.jpg",
            model: "Modelo inspirador: Caminhão guincho Chevrolet Task Force de 1955",
            desc: "Mate é o guincho simpático e meio enferrujado de Radiator Springs. É o melhor amigo de McQueen, leal, inocente e dono de um coração enorme. Apesar de parecer atrapalhado, ele prova sua bravura e inteligência em Carros 2, onde participa de uma missão de espionagem internacional."
        },
        "Sally Carrera": {
            img: "img/sally.jpg",
            model: "Modelo inspirador: Porsche 911 Carrera (2002)",
            desc: "Sally é a advogada e antiga moradora da cidade grande que escolheu viver em Radiator Springs. Inteligente e sensível, é uma das responsáveis pela revitalização da cidade. Ela também é o interesse amoroso de McQueen, apoiando sua transformação pessoal."
        },
        "Ramone": {
            img: "img/ramon.jpg",
            model: "Modelo inspirador: Chevrolet Impala Lowrider de 1959",
            desc: "Ramone é o artista automotivo de Radiator Springs. Ele adora trocar de pintura todos os dias e comanda o 'Ramone’s House of Body Art'. Criativo e carismático, está sempre apoiando os amigos e dando cor à cidade com sua arte."
        },
        "Flo": {
            img: "img/flo.jpg",
            model: "Modelo inspirador: GM Motorama Show Car (1957)",
            desc: "Flo é a dona do V8 Café, ponto de encontro da cidade. Ex-dançarina de shows automotivos, ela é charmosa, sociável e acolhedora. Casada com Ramone, ela traz alegria e hospitalidade a Radiator Springs."
        },
        "Luigi e Guido": {
            img: "img/guido.jpg",
            model: "Modelos inspiradores: Luigi – Fiat 500; Guido – empilhadeira italiana",
            desc: "Luigi é um apaixonado por pneus italianos e fã número um das Ferraris. Guido, seu assistente, é silencioso mas extremamente habilidoso nas trocas de pneus, com velocidade recorde. Juntos, são essenciais nas corridas de McQueen."
        },
        "Sargento": {
            img: "img/sargento.jpg",
            model: "Modelo inspirador: Jeep Willys da Segunda Guerra Mundial",
            desc: "Sargento é um militar aposentado, patriótico e disciplinado. Ele dirige um armazém com produtos militares em Radiator Springs. Vive discutindo com Filmore devido às suas visões opostas sobre o mundo, mas no fundo se importam um com o outro."
        },
        "Filmore": {
            img: "img/filmore.jpg",
            model: "Modelo inspirador: Volkswagen Kombi (Type 2)",
            desc: "Filmore é o hippie da cidade, defensor da paz e dos combustíveis orgânicos. Vive ao lado do Sargento e os dois frequentemente discordam, mas mantém uma amizade divertida. Seu estilo de vida alternativo o torna um personagem único."
        },
        "Xerife": {
            img: "img/xerife.jpg",
            model: "Modelo inspirador: Mercury Eight 1949",
            desc: "Xerife mantém a ordem em Radiator Springs. Foi o primeiro a capturar McQueen após sua chegada desastrosa à cidade. É sério, mas justo, e respeitado por todos como guardião da paz local."
        },
        "Mack": {
            img: "img/mack.jpg",
            model: "Modelo inspirador: Caminhão Mack Super-Liner",
            desc: "Mack é o fiel caminhão-cegonha de McQueen. É responsável por levá-lo às corridas e sempre disposto a ajudar, mesmo que por vezes acabe cochilando em serviço. Representa lealdade e amizade incondicional."
        },
        "Chick Hicks": {
            img: "img/chick.jpg",
            model: "Modelo inspirador: Buick Grand National NASCAR",
            desc: "Chick Hicks é o rival de McQueen no primeiro filme. Arrogante, sarcástico e desleal, ele fará de tudo para vencer, inclusive trapacear. Ele representa o tipo de competidor que valoriza a vitória acima de qualquer coisa."
        },
        "Finn McMissile": {
            img: "img/finn mcmissele.jpg",
            model: "Modelo inspirador: Aston Martin DB5",
            desc: "Finn é um espião britânico experiente e refinado, com diversos gadgets embutidos em seu corpo. Lidera uma operação de espionagem em Carros 2 e envolve McQueen e Mate numa missão internacional cheia de ação."
        },
        "Holley Shiftwell": {
            img: "img/brita.jpg",
        ...
        "Jackson Storm": {
            img: "img/jack.jpg",
            model: "Modelo inspirador: Dodge Charger + design de carros da NASCAR Gen 6",
...
function mostrarInfo(nome) {
    const info = personagensInfo[nome];
    if (info) {
